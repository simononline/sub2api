<template>
  <div v-if="hasActiveSubscriptions" class="relative" ref="containerRef">
    ...
    <button
      @click="toggleTooltip"
      class="flex cursor-pointer items-center gap-2 rounded-full border border-primary-500/30 bg-primary-500/10 px-3 py-1.5 transition-colors hover:border-primary-500/60"
    ...
    <transition name="dropdown">
      <div
        v-if="tooltipOpen"
        class="absolute right-0 z-50 mt-2 w-[340px] overflow-hidden rounded-lg border border-gray-200 bg-white dark:border-dark-800 dark:bg-dark-950"
      >
        <div class="border-b border-gray-100 p-3 dark:border-dark-800">
          ...
          >
            ...
            <div class="space-y-1.5">
              ...
              <div
                ...
                class="flex items-center gap-2 rounded-lg border border-primary-500/30 bg-primary-500/10 px-2.5 py-1.5"
              >
