export default {
  ...
  onlineRecharge: {
    ...
    requests: '请求',
    productList: '商品列表',
    productHint: '点击商品会跳转到第三方网站购买兑换码，购买完成后回到本页输入兑换码进行兑换。',
    buyRedeemCode: '去第三方购买兑换码',
    useRedeemCode: '使用兑换码',
    codePlaceholder: '请输入兑换码',
    redeemHint: '在第三方购买后，将兑换码粘贴到这里兑换。',
    redeem: '兑换',
    redeeming: '兑换中...',
    redeemSuccess: '兑换成功',
    balanceRedeemSuccess: '兑换成功，当前余额为 ${balance}',
    concurrencyRedeemSuccess: '兑换成功，当前并发为 {concurrency} 请求',
    subscriptionRedeemSuccess: '订阅兑换成功',
    subscriptionRedeemSuccessWithGroup: '订阅兑换成功，已开通 {group}',
    storeLinkMissing: '第三方购买链接尚未配置',
    configureProducts: '配置套餐',
    loadingProducts: '加载套餐中...',
    filterAll: '全部',
    productsEmpty: '当前分类暂无套餐',
    configTitle: '配置充值套餐',
    configSubtitle: '启用状态、排序序号、标题、说明、类型关键字和跳转地址会展示在当前充值页。',
    quickConfigTitle: '快速配置',
    quickConfigHint: '可以载入推荐模板，也可以粘贴完整 JSON 一次性生成套餐。',
    recommendedConfig: '推荐配置',
    recommendedApplied: '已载入推荐配置，请替换为你的购买链接',
    jsonConfig: 'JSON 配置',
    jsonConfigLabel: '套餐 JSON',
    jsonConfigPlaceholder: '粘贴套餐 JSON 数组，或包含 products / online_recharge_products 的对象',
    jsonConfigHint: '应用后会覆盖当前弹窗中的套餐列表，保存后才会正式生效。',
    refreshJsonConfig: '生成当前 JSON',
    applyJsonConfig: '应用 JSON',
    invalidJsonConfig: 'JSON 格式不正确，请检查后重试',
    jsonConfigMustBeArray: 'JSON 必须是套餐数组，或包含 products / online_recharge_products 的对象',
    jsonConfigApplied: 'JSON 配置已应用',
    productItem: '套餐 {index}',
    productEnabled: '已启用',
    productDisabled: '已停用',
    productTitleLabel: '标题',
    productTitlePlaceholder: '例如 OpenAI 包月套餐',
    productDescriptionLabel: '描述文字',
    productDescriptionPlaceholder: '例如 每天额度 $20，每周额度 $100',
    targetUrlLabel: '跳转页面目标地址',
    targetUrlPlaceholder: 'https://example.com/buy',
    typeKeywordLabel: '类型关键字',
    typeKeywordPlaceholder: 'OpenAI、Claude、Gemini 或自定义关键字',
    sortOrderLabel: '排序序号',
    ...
    saveProducts: '保存套餐',
    savingProducts: '保存中...',
    noProductToSave: '请至少保留一个套餐',
    productRequired: '请完整填写套餐标题、描述、类型关键字和跳转地址',
    invalidProductUrl: '跳转地址必须是 http(s) 绝对地址',
    productsSaved: '套餐配置已保存',
    productsLoadFailed: '加载套餐配置失败',
    productsSaveFailed: '保存套餐配置失败',
    steps: {
      selectProduct: '选择商品',
      buyRedeemCode: '去第三方购买兑换码',
      useRedeemCode: '使用兑换码'
    ...
    products: {
      lite: {
        name: 'Codex 包月 lite',
        price: '（50元）',
        quota: '每天额度 $20 每周额度 $100 每月额度 $300'
      },
      plus: {
        name: 'Codex 包月 plus',
        price: '（100元）',
        quota: '每天额度 $50 每周额度 $250 每月额度 $750'
      },
      pro: {
        name: 'Codex 包月 pro',
        price: '（150元）',
        quota: '每天额度 $80 每周额度 $400 每月额度 $1200'
      }
    },
    recommended: {
      openai: {
        title: 'OpenAI 推荐套餐',
        description: '适合 OpenAI 模型调用，购买后回到本页兑换。'
      },
      claude: {
        title: 'Claude 推荐套餐',
        description: '适合 Claude 模型调用，购买后回到本页兑换。'
      },
      gemini: {
        title: 'Gemini 推荐套餐',
        description: '适合 Gemini 模型调用，购买后回到本页兑换。'
      }
    }
  },
  ...
  profile: {
    ...
    avatar: {
      title: '资料头像',
      description: '管理当前账号展示的头像。',
      currentHint: '当前账号头像',
      emptyHint: '未设置头像时显示用户名首字母',
      deleteSuccess: '头像已删除',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 weshare-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    accounts: {
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 WeShare 实例的场景。',
    ...
    redeem: {
      ...
      deleteFilteredConfirm: '确定要删除当前筛选条件（{filters}）匹配的 {count} 个兑换码吗？此操作无法撤销。',
      deleteAll: '全部删除',
      deleteFilteredConfirmButton: '删除筛选结果',
      allFilteredCodes: '全部兑换码',
      filterTypeDescription: '类型：{type}',
      filterStatusDescription: '状态：{status}',
      filterSearchDescription: '搜索：{search}',
      filterSeparator: '，',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 WeShare 用户登录',
  ...
  userSubscriptions: {
    ...
    contactGroup: '加群',
    contactQuestion: '问题',
    contactQuestionText: '请填写加群的密钥',
    contactAnswer: '答案',
    configGuideTitle: 'Codex 新手指南',
    configGuideDesc: '按照我们的分步指南配置您的环境，几分钟内即可开始使用 AI 辅助编程。',
    configGuideButton: '查看配置指南',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 WeShare',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">WeShare 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 WeShare 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 WeShare',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 WeShare AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
