export default {
  ...
  setup: {
    title: 'WeShare Setup',
    description: 'Configure your WeShare instance',
    database: {
  ...
  leaderboard: {
    ...
    descriptionMasked: 'Except for your own account, accounts are masked while rank, spend, requests, and token totals remain visible. Join the leaderboard and climb the rankings.',
  ...
  profile: {
    ...
    avatar: {
      ...
      description: 'Manage the avatar currently shown on your account.',
      currentHint: 'Current account avatar',
      emptyHint: 'Your initial is shown when no avatar is set.',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. weshare-backups), choose a region',
    ...
    accounts: {
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another WeShare instance.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for WeShare end-user login',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to WeShare',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the WeShare AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
